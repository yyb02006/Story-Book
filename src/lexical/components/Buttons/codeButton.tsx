import { codeNode } from '#/lexical/plugins/blockTypes'
...
import { CODE_LANGUAGE_COMMAND } from '#/lexical/plugins/codeHighlightPlugin'
import { formatCode } from '#/lexical/plugins/utils'
